    ...
    return ft.Container(
        content=ft.Column(
            [
                ...
                ft.Text(database_path, size=12, color=MUTED, selectable=True),
                ft.Divider(color=ft.Colors.with_opacity(0.12, ft.Colors.WHITE)),
...
def settings_switches(
    ...
    *,
    disabled: bool = False,
) -> tuple[ft.Switch, ft.Switch, ft.Switch]:
    """App option toggles. Order: prefetch, AI block, compact fixtures."""
    ...
    return prefetch, show_ai, compact
