...
Полное описание: [docs/PRODUCT.md](docs/PRODUCT.md). Архитектура: [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md). Правила: [docs/RULES.md](docs/RULES.md). Документация источников: [docs/DATA_SOURCES.md](docs/DATA_SOURCES.md). Порядок изучения доков: [docs/DOC_STUDY.md](docs/DOC_STUDY.md).
